...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        updateSinglePage: function(html) {
            ...
            if (t.options.singlePageShowCounter) {
                t.counter.text((t.current + 1) + ' de ' + t.counterTotal);
            }
        ...
        isImage: function(el) {
            ...
            if ($('<img src="' + el.src + '">').is('img:uncached')) {
                ...
                $(img).on('load' + eventNamespace + ' error' + eventNamespace, function() {
                    ...
                    t.updateImagesMarkup(el.src, el.title, (t.current + 1) + ' de ' + t.counterTotal);
        ...
        isVimeo: function(el) {
            ...
            t.updateVideoMarkup(el.src, el.title, (t.current + 1) + ' de ' + t.counterTotal);
        ...
        isSelfHosted: function(el) {
            ...
            t.updateSelfHostedVideo(el.src, el.title, (t.current + 1) + ' de ' + t.counterTotal);
